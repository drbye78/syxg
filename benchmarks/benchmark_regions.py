...
class RegionBenchmark:
    ...
    def benchmark_region_creation(
        self, region_class: type, descriptor: RegionDescriptor, iterations: int = 100
    ) -> dict[str, float]:
        """
    ...
    def benchmark_sample_generation(self, region: Any, iterations: int = 100) -> dict[str, float]:
        """
        ...
        return {
            ...
            "cpu_load_percent": (total_time / (iterations * self.block_size / self.sample_rate))
            * 100,
    ...
    def run_all_benchmarks(self) -> dict[str, Any]:
        ...
        wt_descriptor = RegionDescriptor(
            ...
            algorithm_params={"wavetable": "default", "unison_voices": 4, "detune_amount": 10.0},
        )
        ...
        phys_descriptor = RegionDescriptor(
            ...
            key_range=(0, 127),
            velocity_range=(0, 127),
            algorithm_params={"model_type": "string", "excitation_type": "pluck"},
        )
        ...
        gran_descriptor = RegionDescriptor(
            ...
            key_range=(0, 127),
            velocity_range=(0, 127),
            algorithm_params={"max_clouds": 4, "density": 10.0},
        )
        ...
        fdsp_descriptor = RegionDescriptor(
            ...
            key_range=(0, 127),
            velocity_range=(0, 127),
            algorithm_params={"phoneme": "a", "excitation_type": "vocal"},
        )
        ...
        an_descriptor = RegionDescriptor(
            ...
            key_range=(0, 127),
            velocity_range=(0, 127),
            algorithm_params={"model_type": "string", "exciter_type": "pluck"},
        )
    ...
    def print_results(self) -> None:
        ...
        print("\n--- Summary ---")
        all_creation_times = [
            data["creation"]["avg_ms"] for data in self.results.values() if "creation" in data
        ]
        all_cpu_loads = [
