...
class ChordTemplate:
    ...
    def get_all_intervals(self) -> set[int]:
        ...
        return set(self.essential_intervals + self.optional_intervals + self.tension_intervals)
...
class ChordCandidate:
    ...
    def to_detected_chord(self) -> DetectedChord:
        ...
        is_inversion = self.bass_note is not None and self.bass_note % 12 != self.root
...
class EnhancedChordDetector:
    ...
    def _calculate_voice_movement(
        self, last_chord: DetectedChord, candidate: ChordCandidate
    ) -> float:
        """
