...
# XGML Sequence Types
SEQUENCE_TYPES = ["track", "events", "parameters"]
...
# Articulation Types
ARTICULATION_TYPES = ["legato", "staccato", "accent", "tenuto"]
...
# Filter Types
FILTER_TYPES = {"lowpass": 0, "highpass": 1, "bandpass": 2, "bandreject": 3}

# LFO Waveforms
LFO_WAVEFORMS = {"triangle": 0, "sawtooth": 1, "square": 2, "sine": 3}
...
MPE_CONTROLLERS = {"timbre": 74, "slide": 75, "lift": 76}
...
# EQ Types
EQ_TYPES = {"flat": 0, "jazz": 1, "pops": 2, "rock": 3, "concert": 4}
