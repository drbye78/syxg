...
class SFZControllerMapper:
    ...
    def process_controller(self, cc_number: int, value: int) -> dict[str, float]:
        ...
        if mapping['bipolar']:
            ...
            param_value = mapping['min_val'] + (bipolar_value + 1.0) * (mapping['max_val'] - mapping['min_val']) / 2.0
        else:
            # Scale to parameter range
            param_value = mapping['min_val'] + curved_value * (mapping['max_val'] - mapping['min_val'])
        ...
        if preset_name == 'basic':
            return {
                ...
                'mappings': [
                    ...
                    {'cc': 10, 'param': 'pan', 'curve': 'linear', 'min_val': -1.0, 'max_val': 1.0, 'bipolar': True},
                    {'cc': 74, 'param': 'cutoff', 'curve': 'exponential', 'min_val': 20.0, 'max_val': 20000.0},
                    {'cc': 71, 'param': 'resonance', 'curve': 'linear', 'min_val': 0.0, 'max_val': 0.99}
                ]
            }
            ...
            return {
                ...
                'mappings': [
                    ...
                    {'cc': 74, 'param': 'cutoff', 'curve': 'exponential', 'min_val': 20.0, 'max_val': 20000.0},
                    {'cc': 71, 'param': 'resonance', 'curve': 'linear', 'min_val': 0.0, 'max_val': 0.99},
                    {'cc': 1, 'param': 'modulation', 'curve': 'smoothstep', 'min_val': 0.0, 'max_val': 1.0},
                    {'cc': 2, 'param': 'breath_control', 'curve': 'logarithmic', 'min_val': 0.0, 'max_val': 1.0},
                    {'cc': 4, 'param': 'foot_control', 'curve': 'linear', 'min_val': 0.0, 'max_val': 1.0},
                    {'cc': 11, 'param': 'expression', 'curve': 'linear', 'min_val': 0.0, 'max_val': 1.0}
                ]
            }
            ...
            return {
                ...
                'mappings': [
                    {'cc': 7, 'param': 'volume', 'curve': 'linear', 'min_val': 0.0, 'max_val': 1.0, 'smoothing': 0.2},
                    {'cc': 10, 'param': 'pan', 'curve': 'sine', 'min_val': -1.0, 'max_val': 1.0, 'bipolar': True, 'smoothing': 0.1},
                    {'cc': 74, 'param': 'cutoff', 'curve': 'exponential', 'min_val': 100.0, 'max_val': 10000.0, 'smoothing': 0.3},
                    {'cc': 71, 'param': 'resonance', 'curve': 'smoothstep', 'min_val': 0.0, 'max_val': 0.8, 'smoothing': 0.2},
                    {'cc': 1, 'param': 'lfo_depth', 'curve': 'linear', 'min_val': 0.0, 'max_val': 1.0},
                    {'cc': 2, 'param': 'filter_envelope_depth', 'curve': 'linear', 'min_val': 0.0, 'max_val': 2.0, 'bipolar': True},
                    {'cc': 4, 'param': 'pitch_modulation', 'curve': 'linear', 'min_val': -12.0, 'max_val': 12.0, 'bipolar': True},
                    {'cc': 11, 'param': 'amplitude', 'curve': 'linear', 'min_val': 0.0, 'max_val': 2.0},
                    {'cc': 91, 'param': 'reverb_send', 'curve': 'linear', 'min_val': 0.0, 'max_val': 1.0},
                    {'cc': 93, 'param': 'chorus_send', 'curve': 'linear', 'min_val': 0.0, 'max_val': 1.0}
                ]
            }
