...
class DelayVariationProcessor:
    ...
    def _process_delay_lcr(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('delay_lcr', {
    ...
    def _process_delay_lr(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('delay_lr', {
            'delay_line_l': np.zeros(self.max_delay_samples, dtype=np.float32),
            'delay_line_r': np.zeros(self.max_delay_samples, dtype=np.float32),
            'write_pos_l': 0,
            'write_pos_r': 0,
    ...
    def _process_dual_delay(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('dual_delay', {
    ...
    def _process_pan_delay(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('pan_delay', {
            'delay_line': np.zeros(self.max_delay_samples, dtype=np.float32),
            'write_pos': 0,
            'feedback': 0.0,
            'lfo_phase': 0.0
    ...
    def _process_cross_delay(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('cross_delay', {
    ...
    def _process_multi_tap_delay(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('multi_tap', {
            'delay_line': np.zeros(self.max_delay_samples, dtype=np.float32),
            'write_pos': 0,
            'feedback': 0.0
        })
    ...
    def _process_reverse_delay(self, stereo_mix: np.ndarray, num_samples: int,
        ...
        state = self._ensure_state('reverse_delay', {
            'delay_line': np.zeros(self.max_delay_samples, dtype=np.float32),
