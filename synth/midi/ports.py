...
try:
    ...
    rtmidi = None
    logger.warning(
        "rtmidi not installed - MIDI port I/O disabled. Install with: pip install rtmidi"
    )
...
def _get_backend() -> MIDIBackend:
    ...
    if _default_backend is None:
        if RTMIDI_AVAILABLE:
            ...
            raise RuntimeError("No MIDI backend available. Install rtmidi: pip install rtmidi")
