...
class ParameterPrioritySystem:
    ...
    def __init__(self):
        ...
        self.parameter_mappings = {
            ...
            "part_volume": {
                "gs": "multipart.parts.{channel}.volume",
                "xg": "channels.{channel}.xg_config.part_level",
            },
            # Pan mappings
            "part_pan": {
                "gs": "multipart.parts.{channel}.pan",
                "xg": "channels.{channel}.xg_config.part_pan",
            },
            # Effects send mappings
            "reverb_send": {
                "gs": "multipart.parts.{channel}.reverb_send",
                "xg": "channels.{channel}.xg_config.effects_sends.reverb",
            },
            "chorus_send": {
                "gs": "multipart.parts.{channel}.chorus_send",
                "xg": "channels.{channel}.xg_config.effects_sends.chorus",
            },
            "variation_send": {
                "gs": "multipart.parts.{channel}.delay_send",
                "xg": "channels.{channel}.xg_config.effects_sends.variation",
            },
            # System effects
            "system_reverb_type": {
                "gs": "system_params.reverb_type",
                "xg": "effects.system_reverb_type",
            },
            "system_chorus_type": {
                "gs": "system_params.chorus_type",
                "xg": "effects.system_chorus_type",
            },
        }
