...
class EffectsSystem:
        ...
        if self.effects_coordinator:
            ...
            if hasattr(self.synthesizer, "xg_components") and self.synthesizer.xg_components:
                return self.synthesizer.xg_components.get_component(
                    "effects"
                ).set_system_reverb_type(reverb_type)
    ...
    def set_system_chorus(self, chorus_type: int, parameters: dict[str, Any] | None = None) -> bool:
        ...
        if self.effects_coordinator:
            ...
            if hasattr(self.synthesizer, "xg_components") and self.synthesizer.xg_components:
                return self.synthesizer.xg_components.get_component(
                    "effects"
                ).set_system_chorus_type(chorus_type)
    ...
    def set_system_variation(
        self, variation_type: int, parameters: dict[str, Any] | None = None
    ) -> bool:
        """
    ...
    def process_channel_effects(
        self, channel_audio: np.ndarray, channel: int, block_size: int
    ) -> np.ndarray:
        """
