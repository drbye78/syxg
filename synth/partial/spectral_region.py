...
class SpectralRegion(IRegion):
    ...
    __slots__ = [
        '_fft_size', '_hop_size', '_spectral_buffer', '_frozen_spectrum',
        '_morph_factor', '_harmonic_enhancement', '_spectral_filter',
        '_freeze_enabled', '_noise_injection', '_fft_processor'
    ]
