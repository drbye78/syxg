...
class AdditiveRegion(IRegion):
    ...
    __slots__ = [
        '_spectrum_type', '_max_partials', '_brightness', '_spread',
        '_morph_factor', '_bandwidth_limit', '_velocity_to_brightness',
        '_spectrum', '_target_spectrum', '_partial_envelopes'
    ]
    ...
    def _create_spectrum(self, spectrum_type: str) -> Optional[Any]:
        ...
        """
        try:
            from ..engine.additive_engine import HarmonicSpectrum
