...
class ConvolutionReverbRegion(IRegion):
    ...
    __slots__ = [
        '_ir_name', '_ir_data', '_wet_level', '_dry_level',
        '_predelay', '_high_freq_damping', '_early_level',
        '_convolution_processor', '_wet_buffer', '_dry_buffer'
    ]
    ...
    def _create_partial(self) -> Optional[Any]:
        ...
        try:
            ...
            self._convolution_processor = ConvolutionProcessor(
                self._ir_data, 
                self.sample_rate
            )
