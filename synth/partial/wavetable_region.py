...
class WavetableRegion(IRegion):
    ...
    __slots__ = [
        'wavetable_bank', '_wavetable_name', '_wavetable_position',
        '_morph_speed', '_unison_voices', '_detune_amount',
        '_filter_cutoff', '_filter_resonance', '_filter_envelope_amount',
        '_velocity_to_filter', '_aftertouch_to_morph',
        '_oscillators', '_filter', '_envelope'
    ]
    ...
    def _create_partial(self) -> Any | None:
        ...
        try:
            ...
            oscillator_params = self._create_unison_oscillators(
                wavetable, frequency
            )
