...
class TestLayeredConfiguration(unittest.TestCase):
    ...
    def test_simple_include(self):
        ...
        # Create base config
        base_config = {"audio": {"sample_rate": 48000}, "includes": ["effects.yaml"]}

        # Create included config
        effects_config = {"effects": {"reverb": {"enabled": True, "type": 4}}}
    ...
    def test_nested_includes(self):
        ...
        # Create base config
        base_config = {"audio": {"sample_rate": 48000}, "includes": ["base.yaml"]}

        # Create base.yaml which includes nested.yaml
        base = {"includes": ["nested.yaml"], "audio": {"polyphony": 64}}

        # Create nested config
        nested = {"effects": {"reverb": {"enabled": True}}}
    ...
    def test_include_stack_tracking(self):
        ...
        base_config = {"includes": ["level1.yaml"]}
        level1 = {"includes": ["level2.yaml"]}
        level2 = {"audio": {"sample_rate": 96000}}
    ...
    def test_relative_path_resolution(self):
        ...
        base_config = {"includes": ["../shared.yaml"]}

        shared = {"audio": {"sample_rate": 96000}}
    ...
    def test_none_removes_key(self):
        ...
        base_config = {
            "effects": {"reverb": {"enabled": True}, "chorus": {"enabled": True}},
            "includes": ["remove_chorus.yaml"],
        }

        remove_chorus = {"effects": {"chorus": None}}
    ...
    def test_circular_include_detection(self):
        ...
        base_config = {"includes": ["a.yaml"]}
        a_config = {"includes": ["b.yaml"]}
        b_config = {
