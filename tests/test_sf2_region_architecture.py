        ...
        for program in range(10):
            ...
            if low_regions and high_regions:
                ...
                if low_sample_ids != high_sample_ids:
                    ...
                    print(f"  High note (84): {len(high_regions)} regions, samples={high_sample_ids}")
                    return
        ...
        for program in range(10):
            ...
            if soft_regions and loud_regions:
                ...
                if soft_sample_ids != loud_sample_ids:
                    ...
                    print(f"  Soft (vel=50): {len(soft_regions)} regions, samples={soft_sample_ids}")
                    print(f"  Loud (vel=120): {len(loud_regions)} regions, samples={loud_sample_ids}")
                    return
    ...
    def test_voice_get_regions_for_note(self, voice_factory):
        ...
        for program in range(5):
            ...
            if regions:
                ...
                print(f"\n✓ Program {program}: get_regions_for_note() returned "
...
class TestSF2BackwardCompatibility:
    ...
    def test_legacy_get_voice_parameters_still_works(self, sf2_engine):
        ...
        params = sf2_engine.get_voice_parameters(
            program=0,
            bank=0,
            note=60,
            velocity=100
