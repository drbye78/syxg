...
class TestMIDIMessageToBytes:
    ...
    def test_pitch_bend_max(self):
        ...
        msg = MIDIMessage(type="pitch_bend", channel=0, data={"value": 16383})
        result = midimessage_to_bytes(msg)
    ...
    def test_none_channel(self):
        ...
        msg = MIDIMessage(type="note_on", channel=None, data={"note": 60, "velocity": 80})
        result = midimessage_to_bytes(msg)
