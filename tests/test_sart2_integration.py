...
class TestArticulationPreset:
    ...
    def test_add_velocity_split(self):
        ...
        preset = ArticulationPreset(name="Test", program=0, bank=0)
    ...
    def test_get_articulation(self):
        ...
        preset = ArticulationPreset(name="Test", program=0, bank=0, default_articulation="normal")
...
class TestArticulationPresetManager:
    ...
    def test_get_presets_by_category(self, preset_manager):
        ...
        piano_preset = ArticulationPreset(name="Piano", program=0, bank=0, category="piano")

        strings_preset = ArticulationPreset(name="Strings", program=48, bank=0, category="strings")
